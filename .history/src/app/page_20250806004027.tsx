        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative animate-fade-in">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-gray-900">{DEVELOPER_INFO.name}</h2>
              <p className="text-sm text-gray-600">{DEVELOPER_INFO.title}</p>
              <p className="text-xs text-gray-500 mb-2">{DEVELOPER_INFO.location}</p>
              <a
              ...
              <div className="flex flex-wrap gap-2 justify-center my-2">
                {DEVELOPER_INFO.techStack.map((tech) => (
                  <span key={tech} className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs font-mono">
                    {tech}
                  </span>
                ))}
              </div>
              <div className="flex flex-col gap-1 mt-2 w-full">
                <a href={DEVELOPER_INFO.portfolio} className="text-blue-700 hover:underline text-xs" target="_blank" rel="noopener noreferrer">Portfolio</a>
                <a href={DEVELOPER_INFO.linkedin} className="text-blue-700 hover:underline text-xs" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                <a href={DEVELOPER_INFO.github} className="text-blue-700 hover:underline text-xs" target="_blank" rel="noopener noreferrer">GitHub</a>
                <a href={`mailto:${DEVELOPER_INFO.email}`} className="text-blue-700 hover:underline text-xs">{DEVELOPER_INFO.email}</a>
              </div>
            </div>
          </div>
        </div>
