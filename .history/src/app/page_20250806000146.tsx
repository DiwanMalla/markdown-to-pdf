...
export default function Home() {
  ...
  // Dynamically import marked and html2pdf.js only on client
  ...
  const renderMarkdown = () => {
    ...
    // marked is only available on client
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center py-8 px-2">
      <h1 className="text-3xl font-bold mb-6 text-center">Markdown to PDF Converter</h1>
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-6 bg-white rounded-lg shadow-lg p-6">
        ...
        />
        <div className="w-full md:w-1/2 h-96 overflow-auto border border-gray-200 rounded-lg bg-gray-100 p-4 prose prose-slate" ref={previewRef}>
      ...
      <p className="mt-4 text-gray-500 text-sm">Live preview updates as you type. PDF will match the preview.</p>
    </div>
  );
}
